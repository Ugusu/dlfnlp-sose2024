...
conda install tqdm==4.66.2 requests==2.31.0 transformers==4.38.2 tensorboard==2.16.2 tokenizers==0.15.1 jupyter matplotlib seaborn -c conda-forge -c huggingface
