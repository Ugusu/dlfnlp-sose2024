...
conda create -n dnlp python=3.10 --override-channels -c defaults
source activate dnlp

# Install packages
conda install pytorch==2.2.0 torchvision==0.17.0 torchaudio==2.2.0 pytorch-cuda=12.1 --override-channels -c pytorch -c nvidia
conda install tqdm==4.66.2 requests==2.31.0 transformers==4.38.2 tensorboard==2.16.2 tokenizers==0.15.1 --override-channels -c conda-forge -c huggingface
